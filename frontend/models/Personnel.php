...
class Personnel extends \yii\db\ActiveRecord
{
    ...
    public static function getSotrud()
    {
        return [
            ...
            ['Должность' => 'Администратор', 'Имя' => 'Бильданова Рузиля Ильсуровна', 'Телефон' => '8(987)223-30-51', 'Магазин' => 'HQ', 'График работы' => '9:00-17:00', 'Вопросы' => 'Все заказы, клиенты, партнеры компании'],
            ...
            ['Должность' => 'Курьер', 'Имя' => 'Абдуллин Руслан Рафилович', 'Телефон' => '8(960)051-51-72', 'Магазин' => 'HQ', 'График работы' => '9:00-17:00', 'Вопросы' => 'Доставка по заказам, товарам, комплектующим, курьерские задачи'],
    ...
    public static function getShop()
    {
        return [
            ...
            ['Название' => 'Магазин', 'Телефон' => '8(903)314-73-92', 'Адрес' => 'Четаева д.35'],
        ];
    }
}
